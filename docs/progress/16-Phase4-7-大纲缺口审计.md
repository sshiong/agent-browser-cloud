...
| 故障矩阵             | 已覆盖 Browser/Node、PostgreSQL、S3/MinIO 超时、Coordinator term=2/3/4、HumanTakeover 全阶段、Agent pending/TYPE_TEXT 已执行未提交与 Runtime 生命周期 Kill/Reconcile、Proxy、Profile Corruption、Key-up、Diff、Workflow DLQ | 补远程桌面网络分区竞态及目标云 Provider 演练       |
