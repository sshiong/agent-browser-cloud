...
var Operations = map[string]Operation{
	...
	"actAgentBrowser":                            {OperationID: "actAgentBrowser", Method: "POST", Path: "/api/v1/sessions/{sessionId}/agent-browser/act", PathParameters: []string{"sessionId"}, QueryParameters: nil, HeaderParameters: []string{"Idempotency-Key", "X-Tenant-Id"}, RequestSchema: "ExecuteAgentBrowserActionsRequest", RequestRequired: true, ResponseSchema: "AgentTask"},
	"waitForAgentBrowser":                        {OperationID: "waitForAgentBrowser", Method: "POST", Path: "/api/v1/sessions/{sessionId}/agent-browser/wait", PathParameters: []string{"sessionId"}, QueryParameters: nil, HeaderParameters: []string{"Idempotency-Key", "X-Tenant-Id"}, RequestSchema: "WaitForAgentBrowserRequest", RequestRequired: true, ResponseSchema: "AgentTask"},
	"handoffAgentBrowser":                        {OperationID: "handoffAgentBrowser", Method: "POST", Path: "/api/v1/sessions/{sessionId}/agent-browser/handoff", PathParameters: []string{"sessionId"}, QueryParameters: nil, HeaderParameters: []string{"Idempotency-Key", "X-Tenant-Id"}, RequestSchema: "HandoffAgentBrowserRequest", RequestRequired: true, ResponseSchema: "AgentTask"},
	...
	"readAgentClipboard":                         {OperationID: "readAgentClipboard", Method: "GET", Path: "/api/v1/sessions/{sessionId}/agent-browser/clipboard", PathParameters: []string{"sessionId"}, QueryParameters: []string{"includeValue"}, HeaderParameters: []string{"X-Tenant-Id"}, RequestSchema: "", RequestRequired: false, ResponseSchema: "AgentClipboard"},
	...
	"createAgentClipboardBridge":                 {OperationID: "createAgentClipboardBridge", Method: "POST", Path: "/api/v1/sessions/{sessionId}/agent-browser/clipboard-bridges", PathParameters: []string{"sessionId"}, QueryParameters: nil, HeaderParameters: []string{"Idempotency-Key", "X-Tenant-Id"}, RequestSchema: "CreateAgentClipboardBridgeRequest", RequestRequired: true, ResponseSchema: "AgentClipboardBridge"},
	"completeAgentClipboardBridge":               {OperationID: "completeAgentClipboardBridge", Method: "POST", Path: "/api/v1/sessions/{sessionId}/agent-browser/clipboard-bridges/{bridgeId}:complete", PathParameters: []string{"bridgeId", "sessionId"}, QueryParameters: nil, HeaderParameters: []string{"X-Tenant-Id"}, RequestSchema: "CompleteAgentClipboardBridgeRequest", RequestRequired: true, ResponseSchema: "AgentClipboardBridge"},
	...
	"claimAgentReviewJob":                        {OperationID: "claimAgentReviewJob", Method: "POST", Path: "/api/v1/agent-review-jobs:claim", PathParameters: nil, QueryParameters: []string{"waitSeconds"}, HeaderParameters: nil, RequestSchema: "ClaimAgentReviewJobRequest", RequestRequired: true, ResponseSchema: "AgentReviewJobClaim"},
	...
	"claimAgentOutcomeJob":                       {OperationID: "claimAgentOutcomeJob", Method: "POST", Path: "/api/v1/agent-outcome-jobs:claim", PathParameters: nil, QueryParameters: []string{"waitSeconds"}, HeaderParameters: nil, RequestSchema: "ClaimAgentOutcomeJobRequest", RequestRequired: true, ResponseSchema: "AgentOutcomeJobClaim"},
	"startAgentOutcomeJob":                       {OperationID: "startAgentOutcomeJob", Method: "POST", Path: "/api/v1/agent-outcome-jobs/{jobId}:start", PathParameters: []string{"jobId"}, QueryParameters: nil, HeaderParameters: nil, RequestSchema: "AgentOutcomeJobClaimRequest", RequestRequired: true, ResponseSchema: "AgentOutcomeJob"},
	"heartbeatAgentOutcomeJob":                   {OperationID: "heartbeatAgentOutcomeJob", Method: "POST", Path: "/api/v1/agent-outcome-jobs/{jobId}:heartbeat", PathParameters: []string{"jobId"}, QueryParameters: nil, HeaderParameters: nil, RequestSchema: "AgentOutcomeJobClaimRequest", RequestRequired: true, ResponseSchema: "AgentOutcomeJob"},
	"completeAgentOutcomeJob":                    {OperationID: "completeAgentOutcomeJob", Method: "POST", Path: "/api/v1/agent-outcome-jobs/{jobId}:complete", PathParameters: []string{"jobId"}, QueryParameters: nil, HeaderParameters: nil, RequestSchema: "CompleteAgentOutcomeJobRequest", RequestRequired: true, ResponseSchema: "AgentOutcomeJob"},
	"failAgentOutcomeJob":                        {OperationID: "failAgentOutcomeJob", Method: "POST", Path: "/api/v1/agent-outcome-jobs/{jobId}:fail", PathParameters: []string{"jobId"}, QueryParameters: nil, HeaderParameters: nil, RequestSchema: "FailAgentOutcomeJobRequest", RequestRequired: true, ResponseSchema: "AgentOutcomeJob"},
	"claimChallengeVisualJob":                    {OperationID: "claimChallengeVisualJob", Method: "POST", Path: "/api/v1/challenge-visual-jobs:claim", PathParameters: nil, QueryParameters: []string{"waitSeconds"}, HeaderParameters: nil, RequestSchema: "ClaimChallengeVisualJobRequest", RequestRequired: true, ResponseSchema: "ChallengeVisualJobClaim"},
	...
	"claimRuntimeValidationJob":                  {OperationID: "claimRuntimeValidationJob", Method: "POST", Path: "/api/v1/enterprise/runtime-validation-jobs:claim", PathParameters: nil, QueryParameters: []string{"waitSeconds"}, HeaderParameters: nil, RequestSchema: "ClaimRuntimeValidationJobRequest", RequestRequired: true, ResponseSchema: "RuntimeValidationJobClaim"},
	...
	"claimRecoveryGameDayJob":                    {OperationID: "claimRecoveryGameDayJob", Method: "POST", Path: "/api/v1/enterprise/recovery-gameday-jobs:claim", PathParameters: nil, QueryParameters: []string{"waitSeconds"}, HeaderParameters: nil, RequestSchema: "ClaimRecoveryGameDayJobRequest", RequestRequired: true, ResponseSchema: "RecoveryGameDayJobClaim"},
...
func (c *Client) ActAgentBrowser(ctx context.Context, request Request) (any, *http.Response, error) {
	return c.Call(ctx, "actAgentBrowser", request)
}
func (c *Client) WaitForAgentBrowser(ctx context.Context, request Request) (any, *http.Response, error) {
	return c.Call(ctx, "waitForAgentBrowser", request)
}
func (c *Client) HandoffAgentBrowser(ctx context.Context, request Request) (any, *http.Response, error) {
	return c.Call(ctx, "handoffAgentBrowser", request)
}
...
func (c *Client) GetAgentBrowserScreenshot(ctx context.Context, request Request) (any, *http.Response, error) {
	return c.Call(ctx, "getAgentBrowserScreenshot", request)
}
func (c *Client) RedeemAgentBrowserScreenshot(ctx context.Context, request Request) (any, *http.Response, error) {
	return c.Call(ctx, "redeemAgentBrowserScreenshot", request)
}
...
func (c *Client) CreateAgentClipboardBridge(ctx context.Context, request Request) (any, *http.Response, error) {
	return c.Call(ctx, "createAgentClipboardBridge", request)
}
func (c *Client) CompleteAgentClipboardBridge(ctx context.Context, request Request) (any, *http.Response, error) {
	return c.Call(ctx, "completeAgentClipboardBridge", request)
}
...
func (c *Client) ClaimAgentOutcomeJob(ctx context.Context, request Request) (any, *http.Response, error) {
	return c.Call(ctx, "claimAgentOutcomeJob", request)
}
func (c *Client) StartAgentOutcomeJob(ctx context.Context, request Request) (any, *http.Response, error) {
	return c.Call(ctx, "startAgentOutcomeJob", request)
}
func (c *Client) HeartbeatAgentOutcomeJob(ctx context.Context, request Request) (any, *http.Response, error) {
	return c.Call(ctx, "heartbeatAgentOutcomeJob", request)
}
func (c *Client) CompleteAgentOutcomeJob(ctx context.Context, request Request) (any, *http.Response, error) {
	return c.Call(ctx, "completeAgentOutcomeJob", request)
}
func (c *Client) FailAgentOutcomeJob(ctx context.Context, request Request) (any, *http.Response, error) {
	return c.Call(ctx, "failAgentOutcomeJob", request)
}
