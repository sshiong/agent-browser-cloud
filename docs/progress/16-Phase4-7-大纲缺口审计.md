...
| 故障矩阵             | 已覆盖 Browser/Node、PostgreSQL、S3/MinIO 超时、Coordinator term=2/3、HumanTakeover EXECUTING 与 Navigate pending Kill/Reconcile、Proxy、Profile Corruption、Key-up、Diff、Workflow DLQ | 补 Runtime 生命周期/有副作用 Agent Step 竞态及目标云 Provider 演练       |
