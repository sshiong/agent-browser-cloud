...
class AgentTaskSummary(TypedDict, total=False):
    ...
    sessionId: str
    goal: str
    state: Literal['PLANNED', 'QUEUED', 'AWAITING_CONFIRMATION', 'BLOCKED', 'RUNNING', 'WAITING_FOR_HUMAN', 'PAUSED_BY_RESOURCE_POLICY', 'COMPLETED', 'FAILED']
