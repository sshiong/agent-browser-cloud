...
public final class BrowserCloudGeneratedClientTest {
  ...
  private static void generatedSurfaceAndRuntimeRequest() {
    ...
    require(BrowserCloudGeneratedClient.OPERATIONS.size() == 239, "operation coverage drifted");
    ...
    Models.AgentBrowserEvaluation evaluation = null;
    require(
        session == null && routing == null && validationClaim == null && evaluation == null,
