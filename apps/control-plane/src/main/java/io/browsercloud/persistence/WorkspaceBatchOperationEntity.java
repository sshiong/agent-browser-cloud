...
import io.browsercloud.api.WorkspaceBatchOperationModels.WorkspaceBatchAction;
...
@Entity
@Table(name = "workspace_batch_operations")
public class WorkspaceBatchOperationEntity {
  ...
  protected WorkspaceBatchOperationEntity() {}

  public WorkspaceBatchOperationEntity(
  ...
  public WorkspaceBatchAction getAction() {
    return WorkspaceBatchAction.valueOf(action);
  }
