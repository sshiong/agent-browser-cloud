...
import type { WorkspaceGroup } from '../models/WorkspaceGroup.js';
import type { WorkspaceGroupListResponse } from '../models/WorkspaceGroupListResponse.js';
import type { WorkspaceGroupRequest } from '../models/WorkspaceGroupRequest.js';
...
export class GroupsService {
    ...
    /**
     * List tenant Workspace Groups with authoritative Session membership
     * @returns WorkspaceGroupListResponse Groups and unassigned Sessions.
     * @throws ApiError
     */
    public listWorkspaceGroups(): CancelablePromise<WorkspaceGroupListResponse> {
    ...
    /**
     * Create an audited Workspace Group
     * @returns WorkspaceGroup Group created.
     * @throws ApiError
     */
    public createWorkspaceGroup({
        idempotencyKey,
        requestBody,
    }: {
        idempotencyKey: string,
        requestBody: WorkspaceGroupRequest,
    }): CancelablePromise<WorkspaceGroup> {
        return this.httpRequest.request({
            method: 'POST',
            url: '/api/v1/groups',
            headers: {
    ...
    /**
     * Update Group metadata and inherited AUTO defaults
     * @returns WorkspaceGroup Group updated.
     * @throws ApiError
     */
    public updateWorkspaceGroup({
        groupId,
        idempotencyKey,
        requestBody,
    }: {
    ...
    /**
     * Delete a Group without terminating its Sessions
     * @returns void
     * @throws ApiError
     */
    public deleteWorkspaceGroup({
        groupId,
        idempotencyKey,
    }: {
        groupId: string,
    ...
    /**
     * Assign a tenant Session to the Group
     * @returns WorkspaceGroup Updated Group.
     * @throws ApiError
     */
    public assignSessionToWorkspaceGroup({
        groupId,
        sessionId,
        idempotencyKey,
    }: {
        ...
        return this.httpRequest.request({
            method: 'PUT',
            url: '/api/v1/groups/{groupId}/sessions/{sessionId}',
            path: {
                'groupId': groupId,
                'sessionId': sessionId,
            },
     ...
     * @throws ApiError
     */
    public unassignSessionFromWorkspaceGroup({
        groupId,
        sessionId,
        idempotencyKey,
    }: {
