...
public final class Models {
  ...
  public record BrowserState(String sessionId, Long contextEpoch, Long stateVersion, Long targetRevision, String url, String title, String stateHash, String stateQuality, List<InteractiveTarget> targets) {}
  ...
  public record UpsertRecoveryContractRequest(Long expectedVersion, List<String> expectedOrigins, List<String> readyRoutePrefixes, List<String> loginRoutePrefixes, List<RecoveryTargetIndicator> requiredTargets, List<RecoveryTargetIndicator> loginTargets, List<RecoveryTargetIndicator> permissionDeniedTargets, List<RecoveryTargetIndicator> accountMismatchTargets, List<String> requiredExtensionIds, List<ProviderEvidenceRequirement> requiredProviderEvidence, Boolean allowDepthLimited, String recoveryAction, Object recoveryExtensionId, Integer maximumAutoRecovery, Boolean enabled) {}
