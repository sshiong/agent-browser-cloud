...
OPERATIONS: dict[str, Operation] = {
    ...
    'createRemoteDesktopConnection': Operation('createRemoteDesktopConnection', 'POST', '/api/v1/sessions/{sessionId}:desktop-connection', ('sessionId',), ('resolutionScalePercent', 'viewOnly'), ('X-Actor-Id', 'X-Tenant-Id'), '', False, 'RemoteDesktopConnection'),
    ...
    'getProfileSessionHealth': Operation('getProfileSessionHealth', 'GET', '/api/v1/profiles/{profileId}/session-health', ('profileId',), (), ('X-Tenant-Id',), '', False, 'ProfileSiteSessionHealthListResponse'),
    ...
    'claimAgentReviewJob': Operation('claimAgentReviewJob', 'POST', '/api/v1/agent-review-jobs:claim', (), ('waitSeconds',), (), 'ClaimAgentReviewJobRequest', True, 'AgentReviewJobClaim'),
    ...
    'claimAgentOutcomeJob': Operation('claimAgentOutcomeJob', 'POST', '/api/v1/agent-outcome-jobs:claim', (), ('waitSeconds',), (), 'ClaimAgentOutcomeJobRequest', True, 'AgentOutcomeJobClaim'),
    ...
    'claimChallengeVisualJob': Operation('claimChallengeVisualJob', 'POST', '/api/v1/challenge-visual-jobs:claim', (), ('waitSeconds',), (), 'ClaimChallengeVisualJobRequest', True, 'ChallengeVisualJobClaim'),
    ...
    'claimRuntimeValidationJob': Operation('claimRuntimeValidationJob', 'POST', '/api/v1/enterprise/runtime-validation-jobs:claim', (), ('waitSeconds',), (), 'ClaimRuntimeValidationJobRequest', True, 'RuntimeValidationJobClaim'),
    ...
    'claimRecoveryGameDayJob': Operation('claimRecoveryGameDayJob', 'POST', '/api/v1/enterprise/recovery-gameday-jobs:claim', (), ('waitSeconds',), (), 'ClaimRecoveryGameDayJobRequest', True, 'RecoveryGameDayJobClaim'),
...
class BrowserCloudGeneratedClient:
    ...
    def getAgentBrowserScreenshot(self, *, path: Mapping[str, Any] | None = None, query: Mapping[str, Any] | None = None, body: Any = None, headers: Mapping[str, str] | None = None) -> Any:
        return self.call('getAgentBrowserScreenshot', path=path, query=query, body=body, headers=headers)

    def redeemAgentBrowserScreenshot(self, *, path: Mapping[str, Any] | None = None, query: Mapping[str, Any] | None = None, body: Any = None, headers: Mapping[str, str] | None = None) -> Any:
        return self.call('redeemAgentBrowserScreenshot', path=path, query=query, body=body, headers=headers)
    ...
    def getProfileSessionHealth(self, *, path: Mapping[str, Any] | None = None, query: Mapping[str, Any] | None = None, body: Any = None, headers: Mapping[str, str] | None = None) -> Any:
        return self.call('getProfileSessionHealth', path=path, query=query, body=body, headers=headers)
