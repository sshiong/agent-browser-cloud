...
1. `tools/sdk/generate_multilang_sdks.py` 读取 Redocly 生成的 OpenAPI 3.1 JSON Bundle，
   确定性生成 Python、Go、Java 的 158 个唯一 Operation 和 215 个公开 Component
...
```text
multilang_sdk_generated=true operations=158 schemas=215
multilang_sdk_verified=true operations=158 schemas=215 languages=python,go,java
