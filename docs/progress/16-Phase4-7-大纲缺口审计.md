...
| 故障矩阵             | 已覆盖 Browser/Node、PostgreSQL、S3/MinIO 超时、Coordinator term=2 与 HumanTakeover EXECUTING Kill/Reconcile、Proxy、Profile Corruption、Key-up、Diff、Workflow DLQ | 补 Runtime 生命周期/Agent Step 进行中 Kill 竞态及目标云 Provider 演练       |
