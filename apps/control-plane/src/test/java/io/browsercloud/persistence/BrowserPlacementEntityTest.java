...
class BrowserPlacementEntityTest {
  ...
  void keepsCurrentMediaEncoderSlotsInsideTheReservedPlacementLimit() {
    ...
    placement.applyResourceAdjustment(
        2_000, 1_536, 3_072, 384, 20, 75, 0, 100, 1, true, true, "[]", 10, 0);
    ...
    assertThat(placement.getSuccessTraceSamplePercent()).isEqualTo(10);
    assertThat(placement.getObserverFrameRateFps()).isZero();
    assertThatThrownBy(
            () ->
                placement.applyResourceAdjustment(
                    2_000, 1_536, 3_072, 384, 20, 75, 0, 100, 3, true, true, "[]", 10, 0))
