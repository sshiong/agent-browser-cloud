...
type AgentBrowserNativeDialog struct {
	DialogId          string `json:"dialogId,omitempty"`
	TabId             string `json:"tabId,omitempty"`
...
type UpsertRecoveryContractRequest struct {
	...
	PaymentSecurityRoutePrefixes     []string                      `json:"paymentSecurityRoutePrefixes,omitempty"`
	CriticalTransactionRoutePrefixes []string                      `json:"criticalTransactionRoutePrefixes,omitempty"`
